...
public class AdminPage extends JFrame implements ActionListener {
    ...
    public void create(Model mod, Controller con) {
        ...
        //create border
        Border blackline = BorderFactory.createTitledBorder("Admin Page");
        ...
        btn_show_db.setPreferredSize(new Dimension(400, 20));
        ...
        JButton btn_hire = new JButton("Add Row");
        btn_hire.setPreferredSize(new Dimension(150, 20));
        c.gridx = 4;
        c.gridy = 2;
        c.gridwidth = 2;
        jp_1.add(btn_hire, c);
        ...
        //  ----------------------------------------  fifth row y = 4
        JTextField txt_em_index = new JTextField(20);
        c.gridx = 0;
        c.gridy = 4;
        c.gridwidth = 4;
        jp_1.add(txt_em_index, c);
        JButton btn_fire = new JButton("Delete Row");
        btn_fire.setPreferredSize(new Dimension(150, 20));
        c.gridx = 4;
        c.gridy = 4;
        c.gridwidth = 2;
        jp_1.add(btn_fire, c);
        ...
        JLabel hder_index_name = new JLabel("Name", 10);
        c.gridx = 1;
        c.gridy = 5;
        c.gridwidth = 1;
        jp_1.add(hder_index_name, c);

        JLabel hder_index_job = new JLabel("Job", 10);
        c.gridx = 2;
        c.gridy = 5;
        c.gridwidth = 1;
        jp_1.add(hder_index_job, c);
        ...
        //  ----------------------------------------  7th row y = 6
        JTextField txt_index_hire = new JTextField(5);
        c.gridx = 0;
        c.gridy = 6;
        c.gridwidth = 1;
        jp_1.add(txt_index_hire, c);

        JTextField txt_index_name = new JTextField(5);
        c.gridx = 1;
        c.gridy = 6;
        jp_1.add(txt_index_name, c);

        JTextField txt_index_job = new JTextField(5);
        c.gridx = 2;
        c.gridy = 6;
        jp_1.add(txt_index_job, c);
        ...
        JButton btn_raise = new JButton("Update Row");
        btn_raise.setPreferredSize(new Dimension(150, 20));
        c.gridx = 4;
        c.gridy = 6;
        ...
        btn_raise.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                    ...
                    String name = txt_index_name.getText();
                    String job = txt_index_job.getText();
                    double sal = Double.parseDouble(txt_index_salary.getText());
                   
                    int index = Integer.parseInt(txt_index_hire.getText());

                    EmployeeUser euser = new EmployeeUser(job, sal, index, name, job);
                    boolean result = mod.updateUser(euser);
                    mod.addToFile();
