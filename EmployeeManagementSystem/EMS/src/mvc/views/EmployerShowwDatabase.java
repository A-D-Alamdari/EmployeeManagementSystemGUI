...
public class EmployerShowwDatabase extends JFrame implements ActionListener{
    
    public void create(Model mod, Controller con) {

        EmployerShowwDatabase mainFrame = new EmployerShowwDatabase();
        mainFrame.setTitle("Employer Database");
        ...
        //create border
        Border blackline = BorderFactory.createTitledBorder("Employer Database");
